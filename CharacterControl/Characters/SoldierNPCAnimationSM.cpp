...
namespace CharacterControl {
	...
	namespace Events {
		...
		PE_IMPLEMENT_CLASS1(SoldierNPCAnimSM_Event_DIE, Event);
	...
	namespace Components {
		...
		void SoldierNPCAnimationSM::addDefaultComponents()
		{
			...
			PE_REGISTER_EVENT_HANDLER(Events::SoldierNPCAnimSM_Event_DIE, SoldierNPCAnimationSM::do_SoldierNPCAnimSM_Event_DIE);
		}
		...
		void SoldierNPCAnimationSM::do_SoldierNPCAnimSM_Event_DIE(PE::Events::Event* pEvt)
		{
			if (m_curId != SoldierNPCAnimationSM::DIE)
			{
				m_curId = SoldierNPCAnimationSM::DIE;
				setAnimation(0, SoldierNPCAnimationSM::DIE,
					0, 0, 0.1f, 0.1f,
					PE::STAY_ON_ANIMATION_END);  // 死亡动画只播放一次
			}
		}
	}
}
