	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				SoldierTPController::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				SoldierGameControls::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
