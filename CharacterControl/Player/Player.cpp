...
PE_IMPLEMENT_CLASS1(Player, Component);

Player::Player(PE::GameContext &context, PE::MemoryArena arena, PE::Handle hMyself, Event_CreatePlayer *pEvt) : Component(context, arena, hMyself)
{
	...
	for (int iSkin = 0; iSkin < numskins; ++iSkin)
	{
		...
		PE::Handle hSoldierAnimSM("PlayerAnimationSM", sizeof(PlayerAnimationSM));
		PlayerAnimationSM *pSoldierAnimSM = new(hSoldierAnimSM) PlayerAnimationSM(*m_pContext, m_arena, hSoldierAnimSM);
    ...
    PE::Handle hSoldierMovementSM("PlayerMovementSM", sizeof(PlayerMovementSM));
	PlayerMovementSM *pSoldierMovementSM = new(hSoldierMovementSM) PlayerMovementSM(*m_pContext, m_arena, hSoldierMovementSM);
    ...
    PE::Handle hSoldierBheaviorSM("PlayerBehaviorSM", sizeof(PlayerBehaviorSM));
	PlayerBehaviorSM *pSoldierBehaviorSM = new(hSoldierBheaviorSM) PlayerBehaviorSM(*m_pContext, m_arena, hSoldierBheaviorSM, hSoldierMovementSM);
