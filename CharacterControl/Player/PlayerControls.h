#ifndef _PLAYER_CONTROLS_H_
#define _PLAYER_CONTROLS_H_
...
namespace CharacterControl {
	namespace Components {
		...
		struct PlayerControls : public PE::Components::Component
		{
			PE_DECLARE_CLASS(PlayerControls);
		public:
			PlayerControls(PE::GameContext& context, PE::MemoryArena arena, PE::Handle hMyself)
