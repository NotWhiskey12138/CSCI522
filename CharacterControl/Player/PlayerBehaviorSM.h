...
struct PlayerBehaviorSM : public PE::Components::Component
{
	PE_DECLARE_CLASS(PlayerBehaviorSM);
	...
	PlayerBehaviorSM(PE::GameContext &context, PE::MemoryArena arena, PE::Handle hMyself, PE::Handle hMovementSM);
	...
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_PlayerMovementSM_Event_TARGET_REACHED)
	virtual void do_PlayerMovementSM_Event_TARGET_REACHED(PE::Events::Event *pEvt);
	//
